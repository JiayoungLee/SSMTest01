...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/cutsom-style.css">
    ...
    <style type="text/css">
        ...
        @font-face {
            ...
            src: url('${pageContext.request.contextPath}/fonts/index/iconfont.eot'); /* IE9*/
            src: url('${pageContext.request.contextPath}/fonts/index/iconfont.eot#iefix') format('embedded-opentype'), /* IE6-IE8 */ url('${pageContext.request.contextPath}/fonts/index/iconfont.woff') format('woff'), /* chrome, firefox */ url('${pageContext.request.contextPath}/fonts/index/iconfont.ttf') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+*/ url('${pageContext.request.contextPath}/fonts/index/iconfont.svg#iconfont') format('svg'); /* iOS 4.1- */
        }
        ...
        <ul id="nav">
            ...
            <shiro:hasRole name="authr">
                ...
                <li><a href="javascript:;"> <i class="iconfont">&#xe629;</i>
                    ...
                    <ul class="sub-menu">
                        <li><a _href="roleController/toUserRole.do"> <i class="iconfont">&#xe6a7;</i>
                            <cite>职工权限分配</cite>
                        </a></li>
